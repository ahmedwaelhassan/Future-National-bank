...
class _MyAppState extends State<LastTransaction> {
  ...
  Future<void> getData(String accnum) async {
    ...
    accountnum12 = data[0]["accountnumber"];
  ...
  Future<List<dynamic>> fetchTransactions(decryptedaccnum) async {
    final response = await http.get(Uri.parse(
        'https://inconspicuous-pairs.000webhostapp.com/getTransaction.php?accountnumber=$accountnum12'));
  ...
  Widget build(BuildContext context) {
    ...
    var date2 = "${date12.year} - ${date12.month} - ${date12.day}".toString();
    var time2 = "${time12.hour} - ${time12.minute}".toString();
    print(date2);
    print(time2);
                                            ...
                                            children: <Widget>[
                                              ...
                                              Row(
                                                children: [
                                                  Container(
                                                    child: Text(
                                                        '  Remain balance : ${decryptedRbalance}',
                                                        style: TextStyle(
                                                            fontSize: 17,
                                                            fontWeight:
                                                                FontWeight
      ...
      pw.Page(
          ...
          build: (context) {
            return pw.Column(children: [
              ...
              pw.Row(children: [
                pw.SizedBox(width: 20),
                pw.Text(" Date : ${time1.hour } : ${time1.minute} ",
                    style: pw.TextStyle(fontSize: 10)),
                pw.Text(" Date : ${date1.day } / ${date1.month} / ${date1.year} ",
                    style: pw.TextStyle(fontSize: 10)),
              ]),
                  ...
                  pw.Column(children: [
                    ...
                    pw.ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final aes = Aes(key);
                          final decryptedDate1 = utf8.decode(
                              aes.decrypt(base64Decode(data?[index]['date1'])));
                          return pw.Column(children: [
                            pw.Container(
                                child: pw.Container(
                  ...
                  pw.Column(children: [
                    ...
                    pw.ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final decryptedfrom = utf8.decode(aes.decrypt(
                              base64Decode(data?[index]['accountnumber'])));
                          final decryptedTooo = utf8.decode(
                              aes.decrypt(base64Decode(data?[index]['tooo'])));
                          final decryptedType = utf8.decode(
                              aes.decrypt(base64Decode(data?[index]['type'])));
                          final decryptedAmount = utf8.decode(aes
                              .decrypt(base64Decode(data?[index]['amount'])));
                          final decryptedRbalance = utf8.decode(aes
                              .decrypt(base64Decode(data?[index]['rbalance'])));
                          final decryptedDate1 = utf8.decode(
                              aes.decrypt(base64Decode(data?[index]['date1'])));
                          final decryptedTime1 = utf8.decode(
                              aes.decrypt(base64Decode(data?[index]['time1'])));
                            ...
                            pw.Container(
                              ...
                              pw.Row(
                                children: [
                                  pw.SizedBox(height: 10),
                                  pw.Container(
                                    child: pw.Text('${decryptedRbalance} ',
                                        style: pw.TextStyle(
                                          fontSize: 10,
                                        )),
                                    padding:
