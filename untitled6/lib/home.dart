                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            Image(
                                              image:
                                              AssetImage("images/depsoitt.png"),
                                              height: 250,
                                              width: 300,
                                            ),
                                          ],
                                            ...
                                            ElevatedButton(
                                                style: ButtonStyle(
                                                    ...
                                                    MaterialStatePropertyAll(
                                                        Color(0xff8d0000))),
                                                onPressed: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Deposit(Email: Email, Password: Password, username: username, mobile: mobile, Gender: Gender, dob: dob, id: id, Adress: Adress, nationalid: nationalid),));
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            Image(
                                              image:
                                              AssetImage("images/currencyy.png"),
                                              height: 250,
                                              width: 300,
                                            ),
                                          ],
